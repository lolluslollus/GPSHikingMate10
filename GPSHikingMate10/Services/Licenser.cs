...
namespace LolloGPS.Services
{
    ...
    {
        private readonly ResourceLoader resourceLoader = ResourceLoader.GetForViewIndependentUse("Resources");
        ...
        private async Task<bool> AskQuitOrBuyAsync(string message1, string message2)
        {
            ...
            UICommand quitCommand = new UICommand(resourceLoader.GetString("LicenserQuit"), (command) => { });
            dialog.Commands.Add(quitCommand);
            UICommand buyCommand = new UICommand(resourceLoader.GetString("LicenserBuy"), (command) => { });
        ...
        public async Task<bool> BuyAsync()
        {
            ...
            if (licenseInformation.IsTrial)
            {
                ...
                {
                    await NotifyAsync(resourceLoader.GetString("LicenserUpgradeFailedLong"), resourceLoader.GetString("LicenserUpgradeFailedShort"));
                    return false;
                }
            }
            else
            {
                ...
                await NotifyAsync(resourceLoader.GetString("LicenserAlreadyBoughtLong"), resourceLoader.GetString("LicenserAlreadyBoughtShort"));
                return true;
            }
        }
        ...
        public async Task<bool> RateAsync()
        {
            ...
            {
                await NotifyAsync(resourceLoader.GetString("LicenserCannotOpenStoreLong"), resourceLoader.GetString("LicenserCannotOpenStoreShort"));
                return false;
            }
        }
        ...
        {
            var dialog = new MessageDialog(message1, message2);
            UICommand okCommand = new UICommand(resourceLoader.GetString("Ok"), (command) => { });
