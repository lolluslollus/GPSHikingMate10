...
namespace LolloGPS.Data.Runtime
{
	public sealed class RuntimeData : ObservableData, IDisposable
	{
		...
		public double DownloadProgressValue { get { return _downloadProgressValue; } private set { if (_downloadProgressValue != value) { _downloadProgressValue = value; RaisePropertyChanged_UI(); } } }
