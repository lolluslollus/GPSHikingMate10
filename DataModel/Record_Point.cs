...
namespace LolloGPS.Data
{
    ...
    public sealed class PointRecord : ObservableData
    {
        ...
        [DataMember]
        public string Symbol { get { return _symbol; } set { _symbol = value; RaisePropertyChanged(); } }
        ...
        public void UpdateDatabase(PersistentData.Tables whichSeries)
        {
            UpdateDb(whichSeries);
        }
